package top.liujianwei.service;

import com.google.common.base.Preconditions;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import top.liujianwei.common.RequestHolder;
import top.liujianwei.dao.SysAclMapper;
import top.liujianwei.dao.SysAclModuleMapper;
...
public class SysAclModuleService {
    ...
    /*private*/ void updateWithChild(SysAclModule before, SysAclModule after) {
        ...
        if (!after.getLevel().equals(before.getLevel())) {
            List<SysAclModule> aclModuleList = sysAclModuleMapper.listChildAclModuleListById(before.getId());
